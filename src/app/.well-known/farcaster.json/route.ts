export async function GET() {
  ...
  const config = {
    accountAssociation: {
      ...
      signature:"MHg4MDY2YWI4MzMwOGUwMTg2ZGEzMjQyMGEzMWJmODI5NmI4MzcyN2ZhODIxY2FjYWViNGE4YmY4YzllNmY2ZjUwNTMwNmZhODJjNmVlZjdlZTVkMjVhMmI2ZDI0NzYwZDllODYxOTI2YTcyN2VkZDU2MTAxY2U2NTBjMzNmYjE3MjFi",
    },
    frame: {
      version: "1",
      name: "Pro",
